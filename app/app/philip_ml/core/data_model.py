...
class AppList(BaseModel):
    ...
    firstTime: str = Field(default=None, title='首次安装时间', example='2020-06-25 09:39:24',
                           description='yyyy-mm-dd HH:MM:SS')
    lastTime: str = Field(title='最近更新时间', example='2020-06-25 09:39:24',
                          description='yyyy-mm-dd HH:MM:SS')

    name: str = Field(default=None, title='名称', example='โคลนโทรศัพท์', description='app名称')
    packageName: str = Field(title='包名', example='com.coloros.backuprestore', description='包名')
...
class CustData(BaseModel):
    BUSI_ID: str = Field(title='订单号', example='1020211106012142000000153', description='唯一标识符')
    ...
    RESOLUTION: str = Field(title='RESOLUTION', example='720\u00d71600 -320')
